...
for (item of hBox) {
    item.addEventListener("click", () => {
        hBoxClicked = !hBoxClicked;
        console.log('hBox.click');
    })
} */
...
// explain box functionality: redone in styles.css
/* const displayOpt = () => {
    const explainBoxHeight = explainBox.style.height;
    console.log(explainBoxHeight);
    if (explainBoxHeight > '15em') {
